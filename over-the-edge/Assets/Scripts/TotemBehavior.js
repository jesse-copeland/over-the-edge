...
private final var rangeOfInfluence = 10;
...
function Update () {
	...
	for (var person in people) {
		var deltaX = person.transform.position.x - this.gameObject.transform.position.x;
		var deltaZ = person.transform.position.y - this.gameObject.transform.position.y;
